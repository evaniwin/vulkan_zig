...
pub const vertices: [4]data = .{
    .{ .vertex = .{ -0.5, -0.5, 0.0 }, .color = .{ 1.0, 0.0, 0.0 }, .texcoord = .{ 1, 0 } },
    .{ .vertex = .{ 0.5, -0.5, 0.0 }, .color = .{ 0.0, 1.0, 0.0 }, .texcoord = .{ 0, 0 } },
    .{ .vertex = .{ 0.5, 0.5, 0.0 }, .color = .{ 0.0, 0.0, 1.0 }, .texcoord = .{ 0, 1 } },
    .{ .vertex = .{ -0.5, 0.5, 0.0 }, .color = .{ 0.0, 1.0, 1.0 }, .texcoord = .{ 1, 1 } },
};
pub const indices: [6]u32 = .{ 0, 1, 2, 0, 2, 3 };
